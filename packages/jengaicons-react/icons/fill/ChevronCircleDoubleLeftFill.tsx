...
const ChevronCircleDoubleLeftFill = forwardRef<SVGSVGElement, JengaIconProps>(
  (props, ref) => {
...
ChevronCircleDoubleLeftFill.displayName = "ChevronCircleDoubleLeftFill";

export default ChevronCircleDoubleLeftFill;
