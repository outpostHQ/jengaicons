...
const DribbbleLogosvgFill = forwardRef<SVGSVGElement, JengaIconProps>(
  (props, ref) => {
...
DribbbleLogosvgFill.displayName = "DribbbleLogosvgFill";

export default DribbbleLogosvgFill;
