...
const MariaDBlogoFill = forwardRef<SVGSVGElement, JengaIconProps>(
  (props, ref) => {
    const { size = 32 } = props;
...
MariaDBlogoFill.displayName = "MariaDBlogoFill";

export default MariaDBlogoFill;
