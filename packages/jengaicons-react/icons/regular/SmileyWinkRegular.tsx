...
const SmileyWinkRegular = forwardRef<SVGSVGElement, JengaIconProps>(
  (props, ref) => {
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M11.5 15.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"
          fill={color || colorCtx || "#000000"}
        />
        <path
          d="M19 14h3M21.197 19.5a6 6 0 0 1-10.394 0"
          stroke={color || colorCtx || "#000000"}
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
